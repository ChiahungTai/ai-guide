...
> EP 依據：`ai-analysis/_tasks/09-11-test-contract-v31/ep.md` S0 段（素材規格／四軸量測／預凍結過線）。
...
6. 產出：素材與 verdict 複製任務家 `ai-analysis/_tasks/09-11-test-contract-v31/mvp/`；報告寫 `ai-analysis/_tasks/09-11-test-contract-v31/mvp-report.md`（素材清單＋逐份 verdict＋四軸數字＋過線判定＋協議修正候選）
