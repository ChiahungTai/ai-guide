...
- DispatchSlice 必攜：revert 預算餘額、sink/accept、budget context（敞口帽／用量帽分欄）、role-dependent read-set——review/verify 禁逐字繼承 implementer reasoning；Intent Review slice 只給 entry 六欄＋final artifact
