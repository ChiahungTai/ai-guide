...
wrapper 退役 phase 2 由 delegate-bridge 2.0.13 落地（ac1de4b：agent 檔刪除＋/delegate 直呼化＋marketplace 版號 bump；跨 repo EP＝bridge repo 00-tasks/09-16-air-68-wrapper-retirement；session fd958534）；本機已裝副本更新 2.0.13、agents/ 零殘影；切口一 AGENTS.md deprecated 指針在位
