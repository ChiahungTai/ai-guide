...
測試對應 EP 凍結 TC（TC-ID 可對上）時，Type B/C/E 判定後強制過本 gate。測試 oracle 的權威分級（S/H/I/N——I/N 禁 autonomous 補強授權）正典見 [acceptance-evidence](../../rules/acceptance-evidence.md)「oracle authority 分級」。
